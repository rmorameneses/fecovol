...
$query = mysql_query('CALL actualizarpersona("'.$id.'","'.$name.'","'.$cedula.'","'.$apellido1.'","'.$email.'","'.$ano.'","'.$telefono.'","'.$genero.'","'.$talla.'","'.$peso.'","'.$asociacion.'","'.$celular.'","' .$countries.'","' .$provincia.'","' .$canton.'","' .$distrito.'","' .$region.'");') or die ("problema al llamar el SP");
$entro=@mysql_fetch_row($query);
echo "<META HTTP-EQUIV='REFRESH' CONTENT='0;URL=http://localhost/atleta.php">
